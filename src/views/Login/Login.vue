    ...
    <div class="relative h-full flex mx-auto">
      ...
      >
        <div class="flex items-center relative text-white">
          <img src="@/assets/imgs/logo.png" alt="" class="w-200px h-130px mr-10px" />
          <span class="text-20px font-bold">{{ underlineToHump(appStore.getTitle) }}</span>
        </div>
        <div class="flex justify-center items-center h-[calc(100%-140px)]">
          <TransitionGroup
            appear
            tag="div"
      ...
      <div class="flex-1 p-30px <sm:p-10px dark:bg-v-dark relative">
        <div class="flex justify-between text-white @2xl:justify-end @xl:justify-end">
